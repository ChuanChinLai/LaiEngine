...
{
	Engine::SubmitTextObject(i_scene, m_pTextObject_PlayerHP, Engine::Asset::Alignment::Left, Engine::Asset::Alignment::Up);
	Engine::SubmitTextObject(i_scene, m_pTextObject_EnemyHP, Engine::Asset::Alignment::Right, Engine::Asset::Alignment::Up);
}
